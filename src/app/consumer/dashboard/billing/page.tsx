...
export default function InvoiceManagement() {
  ...
  return (
    <div className="w-full min-h-full bg-gradient-to-br from-accent-violetto-orange-100 dark:from-gray-900 dark:to-gray-800">
      <div className="container mx-auto px-4 py-6 max-w-7xl">
        {/* Header */}
        <div className="mb-6">
          <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-2xl border border-accent-violet/50 dark:border-gray-700/50 p-6 shadow-lg">
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
              ...
              <div className="flex items-center gap-4">
                <div className="text-right">
                  ...
                  <p className="text-xl font-semibold text-accent-violet">
        ...
        {/* Tabs */}
        <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-2xl border border-accent-violet/50 dark:border-gray-700/50 shadow-lg overflow-hidden">
          <Tabs
          ...
          >
            <TabsList className="grid grid-cols-2 w-full p-1 cursor-pointer bg-transparent">
              <TabsTrigger
                value="invoices"
                className="text-md cursor-pointer data-[state=active]:bg-accent-violet/20 data-[state=inactive]:hover:bg-accent-violet/5 py-3 dark:data-[state=active]:bg-accent-violet/20 data-[state=active]:text-accent-violet rounded-none rounded-tl-lg"
              >
              ...
              <TabsTrigger
                value="payments"
                className="text-md cursor-pointer data-[state=active]:bg-accent-violet/20 py-3 dark:data-[state=active]:bg-accent-violet/20 data-[state=inactive]:hover:bg-accent-violet/5 data-[state=active]:text-accent-violet rounded-none rounded-tr-lg"
              >
              ...
              <div className="space-y-6">
                ...
                <div className="flex flex-col lg:flex-row gap-4 mb-6 p-5">
                  <div className="relative flex-1">
                    <Search className="absolute left-3 top-4 transform -translate-y-1/2 h-5 w-5 text-accent-violet" />
                    <Input
                      placeholder="Search invoices..."
                      value={searchQuery}
                      onChange={(e) => setSearchQuery(e.target.value)}
                      className="pl-10 pr-20 py-2.5 text-sm bg-transparent dark:bg-slate-900 border-accent-violet/20 dark:border-slate-700 rounded-lg focus-visible:ring-0 focus-visible:border-accent-violet border-2 transition-all duration-200"
                    />
                  </div>
                  <div className="flex flex-col sm:flex-row gap-4 items-stretch sm:items-center">
                    <Button
                      className="bg-accent-violet hover:bg-accent-violet text-white duration-200 shadow-lg hover:shadow-xl transform hover:scale-105 transition-all"
                ...
                {filteredInvoices.length > 0 ? (
                          ...
                          <div className="p-4 flex justify-between items-center gap-4">
                            ...
                            <div className="flex items-center gap-3 min-w-0">
                              <div className="relative">
                                <div className="w-10 h-10 bg-accent-violet/20 rounded-lg flex items-center justify-center shadow-sm">
                                  <FileText className="w-5 h-5 text-accent-violet dark:text-accent-violet" />
                                </div>
                              </div>
                            ...
                            <div className="text-right space-y-1">
                              <div className="p-1 rounded-full bg-accent-violet/60 dark:bg-accent-violet/30 inline-block transition-transform duration-300">
                                {expandedInvoice === invoice.id ? (
                                  <ChevronUp className="h-4 w-4 text-accent-violet dark:text-accent-violet" />
                                ) : (
                                  <ChevronDown className="h-4 w-4 text-accent-violet dark:text-accent-violet" />
                                )}
                              </div>
                            </div>
                          </div>
                            ...
                            <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-6 text-sm">
                              ...
                              <div className="flex-1 p-4 rounded-lg">
                                <div className="space-y-1 mb-3">
                                  <h4 className="flex items-center gap-2 text-accent-violet dark:text-accent-violet font-semibold">
                              ...
                              <div className="flex-1 p-4 rounded-lg bg-accent-violet/10 dark:from-gray-800 dark:to-accent-violet/10 border border-accent-violet/50 dark:border-accent-violet/30">
                                <h4 className="flex items-center gap-2 text-accent-violet dark:text-accent-violet font-semibold mb-2">
                                ...
                                <div className="space-y-1 text-sm">
                                  ...
                                  <div className="pt-2 mt-2 border-t border-accent-violet/50 dark:border-accent-violet/30 font-semibold flex justify-between">
                                    <span>Total</span>
                                    <span className="text-accent-violet dark:text-accent-violet font-bold">
                              ...
                              <div className="flex flex-col gap-2 md:w-40">
                                <Button
                                  className="bg-accent-violet/10 text-accent-violet hover:bg-accent-violet hover:text-white dark:bg-accent-violet/20 dark:hover:bg-accent-violet/90 dark:hover:text-white border border-accent-violet dark:border-accent-violet font-semibold shadow-sm hover:shadow-md transition-all"
                  ...
                  <div className="text-center py-16 rounded-xl border-accent-violet border-dotted border-2 bg-muted/30 dark:bg-muted/10">
                    <FileText className="h-14 w-14 mx-auto text-accent-violet mb-3" />
            ...
            <TabsContent value="payments" className="p-6">
              <div className="space-y-6">
                <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6 py-2 mx-3">
                  ...
                  <Button className="bg-accent-violet hover:bg-accent-violet text-white transition-all duration-200 shadow-lg hover:shadow-xl transform hover:scale-105">
                ...
                <div className="space-y-4 overflow-hidden">
                  {paymentMethods.map((method, index) => (
                    ...
                    >
                      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                        <div className="flex items-center gap-4">
                          <div className="w-12 h-12 bg-accent-violet/30 rounded-xl flex items-center justify-center">
                            {method.type === "card" ? (
                              <CreditCard className="h-6 w-6 text-accent-violet" />
                            ) : (
                              <Landmark className="h-6 w-6 text-accent-violet" />
                            )}
                          </div>
                          <div>
                            <div className="flex flex-col sm:flex-row sm:items-center gap-2">
                              ...
                              {method.isDefault && (
                                <span className="px-3 py-1 bg-accent-violet text-white text-xs rounded-full font-medium w-fit">
                                  Default
                                </span>
                              )}
                            </div>
                        ...
                        <div className="flex flex-col sm:flex-row gap-2 w-full sm:w-auto">
                          {!method.isDefault && (
                            <Button
                              size="sm"
                              className="bg-accent-violet/30 text-accent-violet hover:bg-accent-violet hover:text-white dark:bg-accent-violet/30 dark:text-accent-violet transition-colors duration-200 shadow-none"
                            >
                              Set as Default
                            </Button>
                          )}
            ...
            <form onSubmit={handleNewInvoiceSubmit} className="p-6 space-y-4">
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md focus:outline-none focus:ring-2 focus:ring-accent-violet dark:bg-gray-700 dark:text-white transition-colors duration-200 resize-none"
                  rows={3}
                  required
                />
              </div>
              ...
              <div className="flex gap-3 pt-4">
                ...
                <Button
                  type="submit"
                  className="flex-1 bg-accent-violet hover:bg-accent-violet text-white transition-colors duration-200"
                >
                  Create Invoice
                </Button>
              </div>
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex justify-between font-medium text-lg pt-2 border-t">
                    <span>Total</span>
                    <span className="text-accent-violet dark:text-accent-violet">
                ...
                <div className="flex justify-between items-center">
                  ...
                  <div className="flex gap-2">
                    <Button
                      size="sm"
                      className="bg-accent-violet hover:bg-accent-violet text-white"
                    >
