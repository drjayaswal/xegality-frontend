        ...
        <div className="max-w-7xl mx-auto h-full flex flex-col">
          ...
          <div className="text-center mb-10">
            <h1 className="text-4xl font-extrabold text-slate-900 mb-3">
              <span className="bg-gradient-to-r from-accent-violet via-amber-500 to-rose-500 bg-clip-text text-transparent">
                Xegality's Plan
              </span>
            </h1>
            ...
            {/* Footer */}
            <div className="mt-8 mb-3 py-6 border-t border-violet-100 dark:border-violet-800 bg-gradient-to-r from-amber-50/30 to-orange-100/30 dark:from-violet-900/10 dark:to-violet-900/10 rounded-xl">
