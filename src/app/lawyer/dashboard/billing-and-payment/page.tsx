        ...
        <div className="flex border-b border-white/20">
          <button
            ...
            className={cn(
              ...
              activeTab === "invoices"
                ? "dark:text-amber-400 text-amber-600 border-b-2 border-amber-600"
              ...
              <div className="space-y-6">
                ...
                <div className="flex flex-col md:flex-row gap-4 mb-6">
                  <div className="relative flex-1">
                    <Search className="absolute left-3 top-2 h-5 w-5 text-amber-700" />
                    <Input
                      placeholder="Search invoices..."
                      value={searchQuery}
                      onChange={(e) => setSearchQuery(e.target.value)}
                      className="pl-10 bg-white/30 focus:ring-0 focus-visible:border-amber-700 border-amber-700/20 focus-visible:ring-0"
                    />
                  </div>
                  <div className="flex gap-4 justify-center items-center">
                    ...
                    <Button className="text-white bg-amber-600 hover:bg-amber-700 ml-2">
                      ...
                      >
                        ...
                        >
                          <div className="flex items-center gap-3">
                            <div className="w-10 h-10 bg-transparent dark:bg-amber-900/50 rounded-lg flex items-center justify-center">
                            ...
                            <div className="pt-4 grid grid-cols-1 md:grid-cols-2 gap-4">
                              ...
                              <div className="flex flex-col justify-between">
                                ...
                                <div className="flex gap-2 mt-4 justify-end">
                                  <Button className="gap-2 bg-green-600/20 text-green-600 shadow-none hover:bg-green-600 hover:text-white">
                    ...
                    >
                      <div className="flex items-center justify-between">
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            <div className="flex items-center gap-2">
                              ...
                              {method.isDefault && (
                                <span className="px-2 py-0.5 bg-amber-600 dark:bg-amber-900/50 text-white text-xs rounded-full">
                                  Default
                                </span>
                              )}
                            </div>
                        ...
                        <div className="flex gap-2">
                          ...
                          <Button
                            size="sm"
                            className="hover:bg-red-600 text-red-600 bg-red-50 dark:hover:bg-white/50 hover:text-white shadow-none"
                          >
                            Remove
                          </Button>
                        </div>
                ...
                <div className="mt-8 rounded-xl border border-white/20 p-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                      ...
                      <Button
                        variant="link"
                        className="p-0 h-auto mt-2 text-amber-600 hover:text-amber-700"
                      >
