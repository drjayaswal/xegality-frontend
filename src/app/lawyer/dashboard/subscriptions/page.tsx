...
export default function CompactSubscription() {
  ...
  return (
    <div className="min-h-full w-full bg-white flex items-center justify-center px-4 py-10">
      <div className="w-full max-w-7xl bg-white rounded-lg shadow-none overflow-hidden">
        {/* Main Content */}
        <div className="px-6 py-10">
          ...
          {/* Footer */}
          <div className="mt-12 pt-6 rounded-xl">
            <div className="flex flex-col sm:flex-row items-center justify-center gap-6 text-sm text-gray-700 dark:text-gray-300">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="font-medium">Trusted by 10,000+ Lawyers</span>
              </div>
            </div>
          </div>
        </div>
