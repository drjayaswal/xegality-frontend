...
export default function HelpSupport() {
  ...
  const faqs: FAQ[] = [
    ...
    {
      question: "How do I manage my academic tasks and deadlines?",
      answer:
        "Navigate to the Tasks tab and click 'Add Task'. Enter the assignment or project name, due date, and relevant course or subject. You can categorize tasks by priority and set reminders via email or in-app notifications. The dashboard provides a calendar view for better planning.",
      category: "Academic Management",
      popularity: 91,
    },
    {
      question: "How do I track internship applications and interviews?",
      answer:
        "Go to the Career section and click 'New Application'. Fill in the internship details, application date, company name, role, and any notes. You can log interview dates, upload resumes and cover letters, and set follow-up reminders.",
      category: "Career Support",
      popularity: 87,
    },
    {
      question: "Can I collaborate with classmates on shared projects?",
      answer:
        "Yes, go to the Projects tab, click 'New Project', and invite your classmates via email or platform usernames. You can assign roles, set deadlines, upload documents, and communicate via threaded comments or group chat.",
      category: "Collaboration",
      popularity: 84,
    },
    {
      question: "How do I access legal research tools within the platform?",
      answer:
        "Navigate to the Resources tab and select 'Legal Research'. You'll find links to case databases, statutes, and citation tools. You can bookmark frequently used resources and create custom research folders.",
      category: "Legal Education",
      popularity: 80,
    },
    {
      question: "How do I request mentorship or tutoring support?",
      answer:
        "Go to the Mentorship section and click 'Request Mentor'. Choose a topic or area of support (e.g., exam prep, research, internships), and you'll be matched with available mentors. Sessions can be scheduled via the integrated calendar.",
      category: "Student Support",
      popularity: 76,
    },
    {
      question: "Can I organize my notes and lecture recordings?",
      answer:
        "Yes, use the Notes tab to create organized folders by subject. You can upload PDFs, type notes, or attach audio recordings. The system supports voice-to-text and search by keyword across all notes.",
  ...
  const articles: Article[] = [
    ...
    {
      id: "stu-art-1",
      title: "Top Tools for Law Students in 2025",
      excerpt:
        "Discover essential digital tools to help you stay organized, study efficiently, and manage legal research like a pro.",
      category: "Productivity",
      readTime: "6 min read",
      popularity: 92,
      isNew: true,
    ...
    {
      id: "stu-art-2",
      title: "Mastering Time Management in Law School",
      excerpt:
        "Practical strategies for balancing coursework, extracurriculars, and personal life as a busy law student.",
    ...
    },
    {
      ...
      excerpt:
        "Step-by-step guide on what to expect, how to prepare, and how to impress during your first legal internship.",
      category: "Career Support",
      readTime: "8 min read",
      popularity: 86,
    },
    {
      id: "stu-art-4",
      title: "Legal Research Made Simple",
      excerpt:
        "An easy-to-follow breakdown of legal research techniques and tools every student should know.",
      category: "Legal Education",
      readTime: "10 min read",
      popularity: 84,
    },
    {
      id: "stu-art-5",
      title: "Note-Taking Techniques for Law Students",
      excerpt:
        "Compare different note-taking styles—IRAC, outlines, mind maps—and find what works best for you.",
    ...
    {
      id: "stu-art-6",
      title: "Using AI for Smarter Studying",
      excerpt:
        "Explore how generative AI tools can help with summarizing readings, generating flashcards, and writing practice essays.",
      category: "Technology",
      readTime: "5 min read",
      popularity: 85,
      isNew: true,
  ...
  return (
    <div className="flex flex-col h-full relative border border-slate-200 dark:border-slate-800 rounded-xl shadow-sm bg-white dark:bg-slate-900 overflow-hidden max-w-7xl mx-auto">
      {/* Header */}
      <div className="relative overflow-hidden bg-gradient-to-br from-emerald-900 via-cyan-950 to-emerald-900">
                        ...
                        >
                          ...
                          >
                            <div className="flex items-center gap-3 flex-1">
                              <div className="p-1.5 bg-gradient-to-br from-emerald-700 via-cyan-750 to-emerald-700 text-white dark:bg-emerald-900/30 rounded-4xl">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                      {articles.map((article, index) => (
                        <motion.div
                          ...
                          animate={{ opacity: 1, y: 0 }}
                          transition={{ delay: index * 0.05 }}
                          className="bg-white flex flex-col justify-between dark:bg-slate-800 rounded-xl p-5 border border-slate-200 dark:border-slate-700 hover:shadow-lg hover:border-emerald-300 dark:hover:border-emerald-600 transition-all duration-200"
                        >
                          ...
                          <div className="flex items-center justify-between">
                            ...
                            <Button
                              size="sm"
                              className="h-6 py-4 bg-transparent text-emerald-600 hover:text-emerald-700 shadow-none hover:bg-emerald-800/20"
                            >
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                          <div>
                            ...
                            <Input
                              ...
                              required
                              className="bg-slate-50 dark:bg-slate-900 border-slate-200 dark:border-slate-700 focus-visible:ring-0 focus-visible:border-emerald-500"
                            />
                          </div>
                          <div>
                            <label
