      ...
      <div className="w-full h-full rounded-lg overflow-hidden flex relative">
        ...
        <AnimatePresence>
          {showSidebar && (
            ...
            >
              {/* Header */}
              <div className="p-5 bg-emerald-700/10">
                <div className="relative">
                  {searchQuery && (
                    <>
                      <ArrowRight className="absolute left-3 top-2 h-5 w-5 text-emerald-700" />
                    </>
                  )}
                  <Input
                    ...
                    className={cn(
                      "bg-transparent rounded-2xl text-left focus-visible:ring-0 border-2 border-emerald-700/40 focus-visible:scale-105 focus-visible:border-emerald-700/40 transition-all duration-150 dark:placeholder:text-white/40 placeholder:text-black/40",
              ...
              {/* Conversations List */}
              <ScrollArea className="flex border-t-2 border-emerald-700/50  bg-emerald-700/10">
                      ...
                      <motion.div
                        ...
                        className={cn(
                          ...
                          selectedConversation === conversation.id
                            ? "bg-gray-50/30 backdrop-blur-lg shadow-lg shadow-emerald-800"
                            : "hover:bg-gray-50/20 backdrop-blur-sm m-1 shadow-emerald-800"
                        )}
          ...
          {selectedConversation ? (
            <>
              ...
              <div className="flex-1 flex flex-col h-full">
                ...
                <div
                  className={`flex-shrink-0 px-4 py-[8px] bg-emerald-700/5 border-b-2 ${
                    activeButton == "phone"
                      ? "border-b-sky-500"
                      : activeButton == "video"
                      ? "border-b-green-500"
                ...
                >
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3 p-2">
                      ...
                      <div className="relative">
                        <div className="w-10 h-10 p-2 bg-emerald-700 rounded-full flex items-center justify-center">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <Button
                        variant="ghost"
                        size="sm"
                        className={`h-8 w-8 p-0 flex gap-1 rounded-full ${
                          activeButton === "video"
                ...
                <div className="flex-1 min-h-0 bg-emerald-700/5 relative overflow-hidden">
                  <ScrollArea className="h-full" ref={scrollAreaRef}>
                    <div className="p-4 space-y-4">
                      <AnimatePresence>
                        {currentConversation!.messages.map((message) => (
                          ...
                          >
                            {message.sender === "client" && (
                              <div
                                className={cn(
                                  ...
                                  "bg-emerald-700 rounded-full rounded-r-none"
                                )}
                              >
                            ...
                            {message.sender === "lawyer" && (
                              <div className="w-8 h-8 rounded-l-none bg-emerald-700 rounded-full flex items-center justify-center">
                                <User className="h-4 w-4 text-white" />
                              </div>
                            )}
                          </motion.div>
                      ...
                      {isTyping && (
                        ...
                        >
                          <div className="w-8 h-8 bg-emerald-700 rounded-full flex items-center justify-center shadow-md">
                            <User className="h-5 w-5 text-white" />
                          </div>
                          <div className="bg-transparent dark:text-white/90 text-black/90 -ml-3 mt-1 p-2 rounded-2xl rounded-l-none shadow-none">
                            <div className="flex gap-1">
                              ...
                              <div
                                className="w-2 h-2 bg-emerald-700 rounded-full animate-bounce"
                ...
                <div className="flex-shrink-0 p-4 bg-emerald-700/5">
                  <div className="flex flex-wrap md:flex-nowrap items-center gap-3">
                    <Button
                      onClick={handleUploadClick}
                      disabled={showUploadAnimation}
                      className="flex items-center gap-2 rounded-full text-gray-600 text-sm bg-transparent shadow-none hover:bg-transparent border-1 border-transparent hover:border-emerald-700/80 px-4 md:px-8 py-2 hover:text-indigo-900 hover:scale-105 transition-all duration-150 w-full md:w-auto mb-2 md:mb-0"
                    >
                      {showUploadAnimation ? (
                        <motion.div
                        ...
                        <Paperclip className="w-4 h-4 text-emerald-700 dark:text-white/70" />
                      )}
                      {showUploadAnimation ? (
                        <>
                          <span>Uploading...</span>
                        ...
                        <span className="text-emerald-700 dark:text-white/70">
                          Attach
                        </span>
                      )}
                    </Button>
                    <div className="flex-1 relative w-full">
                      <Input
                        ...
                        className="bg-gray-50/20 text-left focus-visible:ring-0 border-1 border-emerald-700/40 focus-visible:border-emerald-700/40 transition-all duration-150 dark:placeholder:text-white/40 placeholder:text-black/40"
                      />
                    </div>
                    <div className="flex gap-2 w-full md:w-auto justify-end mt-2 md:mt-0">
                      <Button
                        className="h-10 w-10 bg-emerald-700 hover:bg-emerald-700 hover:scale-110 text-white rounded-full"
                      ...
                      <Button
                        ...
                        className="h-10 w-10 p-0 bg-emerald-700 hover:bg-emerald-700 hover:scale-110 text-white rounded-full"
                      >
            ...
            <div className="flex-1 flex items-center justify-center bg-emerald-700/5">
