...
function XegalityAIContent() {
  ...
  return (
    <div className="shadow-lg border-[1.5px] bg-gray-50 flex flex-col relative rounded-lg h-full overflow-hidden">
      {/* Hidden file input */}
      <input
        ref={fileInputRef}
        type="file"
            ...
            <div className="space-y-4 pb-4">
              <AnimatePresence>
                {messages.map((message) => (
                  ...
                  >
                    {message.sender === "ai" && (
                      <div className="w-10 h-10 bg-emerald-700 rounded-full rounded-r-none flex items-center justify-center shadow-md">
