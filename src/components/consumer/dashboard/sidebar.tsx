                  ...
                  <SidebarMenuItem key={index} className="">
                    <SidebarMenuButton
                      ...
                      className={cn(
                        ...
                        isActive && "hover:bg-accent-violet"
                      )}
                    >
                      <Link
                        href={item.url}
            ...
            <SidebarMenu className="">
              {quick_links.map((item) => (
                <SidebarMenuItem key={item.title} className="">
                  <SidebarMenuButton
                    asChild
                    className="pl-4 hover:bg-accent-violet/5 hover:text-accent-violet"
                  >
          ...
          <SidebarMenuItem>
            <DropdownMenu>
              <SidebarMenuButton
                variant={"default"}
                size={"lg"}
                className="cursor-pointer bg-gradient-to-br from-accent-violet/5 to-accent-violet/20"
                asChild
              >
              ...
              <DropdownMenuContent
                side="right"
                sideOffset={15}
                className="mb-2 rounded-xl shadow-sm -ml-1"
              >
