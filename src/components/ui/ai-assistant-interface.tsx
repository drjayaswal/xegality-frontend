...
export function AIAssistantInterface({
  ...
  return (
    <div className="w-full max-w-4xl mx-auto p-3 sm:p-5">
      ...
      <div className="bg-transparent backdrop-blur-lg rounded-2xl sm:rounded-3xl dark:border-white-900/10 shadow-none focus-within:shadow-xl focus-within:bg-white/60 bg-white/50 dark:focus-within:bg-white-900/10 transition-all duration-300 mb-4">
        {/* Input Field */}
      ...
      <AnimatePresence>
        {activeCommandCategory && (
          <motion.div
            ...
            className="bg-white/40 dark:bg-gray-900/40 backdrop-blur-lg rounded-xl sm:rounded-2xl border border-white/60 dark:border-gray-700/60 shadow-lg overflow-hidden"
          >
            {commandSuggestions[
